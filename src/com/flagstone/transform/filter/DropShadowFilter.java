...
public final class DropShadowFilter implements Filter {
	...
	public DropShadowFilter(final SWFDecoder coder, final Context context) throws CoderException {
	...
	public DropShadowFilter(Color shadow, float blurX, float blurY, 
