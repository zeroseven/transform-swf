...
public final class GlowFilter implements Filter {
	...
	public GlowFilter(final SWFDecoder coder, final Context context) throws CoderException {
	...
	public GlowFilter(Color color, float blurX, float blurY, 
			float strength, Mode mode, int passes) {
		this.color = color;
	...
	public String toString() {
		return String.format(FORMAT, color, getBlurX(), getBlurY(), strength, passes);
	}
	...
	public boolean equals(final Object object) {
		...
		if (object == null) {
			...
			result = color.equals(filter.color) && 
