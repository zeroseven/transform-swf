...
public final class ConvolutionFilter implements Filter {
	...
	public String toString() {
		return String.format(FORMAT, matrix, divisor, bias, color, 
				clamp, alpha);
	}
	...
	@Override
	public int hashCode() {
		return (((((matrix.hashCode()*31) + Float.floatToIntBits(divisor))*31 + 
				Float.floatToIntBits(bias))*31 + color.hashCode())*31 + 
