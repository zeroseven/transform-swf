...
public final class MovieTimingTest {
	...
	private void decode(final File source) throws FileNotFoundException, IOException,
			DataFormatException {
		...
		final double duration = (System.currentTimeMillis() - before) / iterations;
	...
	private void encode(final File source) throws FileNotFoundException, IOException,
			DataFormatException {
